...
class PlaylistBody extends StatefulWidget {
  ...
  const PlaylistBody({Key? key, required this.secondRenderFunction}) : super(key: key);
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate(
              ...
              context
                  .read<SpotifyCubit>()
                  .userPlaylists[index];
              return IndividualPlaylist(playListObject: track, index: index + 1, renderFunction: widget.secondRenderFunction,);
            },
            childCount:
            context
                .read<SpotifyCubit>()
...
// // context.push("/alarms/add_alarm/playlists/tracks", extra: widget.renderFunction);
// Navigator.of(context).push(
// MaterialPageRoute(builder: (context) => TracksScreen(renderFunction: widget.renderFunction,)),
// );
//
